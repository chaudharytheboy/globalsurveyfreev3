                                    ...
                                    <div class="row offer-row"
                                        ...
                                        <a href="<?php echo $row['url_1'];?>"
                                                target="_blank"><img id="offer_img_2" class="img-responsive"
                                                    style="max-width: 100%; height: 100px; margin: 0 auto;" src="<?php echo $row['images'];?>"
                                            ...
                                            {
                                            ?>
                                            <img src="images/products_image/default-product-img.jpg" width="100%" height="100px">
                                            <?php
                                            }
                                            ?>
                                        </div>
                                        ...
                                        {
                                        ?>
                                        <img src="<?php echo $row['img_popular'];?>" width="100%" height="50px">
                                        <?php
                                        }
                                        ?>
